...
00000020 <printf>:
{
  ...
  40:	e8 5d 03 00 00       	call   3a2 <write>
}
  ...
  54:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
  59:	c7 44 24 04 34 04 00 	movl   $0x434,0x4(%esp)
  60:	00 
  ...
  printf(1, "fork test OK\n");
  be:	c7 44 24 04 66 04 00 	movl   $0x466,0x4(%esp)
  c5:	00 
  ...
  d7:	c3                   	ret    
  write(fd, s, strlen(s));
  d8:	c7 04 24 74 04 00 00 	movl   $0x474,(%esp)
  df:	e8 fc 00 00 00       	call   1e0 <strlen>
  e4:	c7 44 24 04 74 04 00 	movl   $0x474,0x4(%esp)
  eb:	00 
  ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f3:	89 44 24 08          	mov    %eax,0x8(%esp)
  f7:	e8 a6 02 00 00       	call   3a2 <write>
    exit(1);
 ...
 114:	c7 44 24 04 3f 04 00 	movl   $0x43f,0x4(%esp)
 11b:	00 
 ...
 134:	c7 44 24 04 53 04 00 	movl   $0x453,0x4(%esp)
 13b:	00 
